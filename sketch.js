...
swimmer2animation= loadAnimation("images/d1.png", "images/d2.png", "images/d3.png", "images/d4.png", "images/d5.png","images/d6.png","images/d7.png","images/d8.png","images/d9.png")
...
music=loadSound("images/bgmusic.mp3")
...
swimmer2.addAnimation("swimmer animation", swimmer2animation)
...
swimmer2.collide(edges[2])
swimmer2.collide(edges[3])
drawSprites();
textSize(30)
stroke("black")
strokeWeight(3)
...
text(player2name+"'s Life : "+life2,width-250,50)
text(player2name+"'s Score : "+score2,width-250,100)
...
function spawnObstacles() {
    ...
    obstacle.y=Math.round(random(50,windowHeight))
      ...
      obstacle.velocityX = -(8 + 3*score1/100);
     ...
     // obstacle.debug=true
      obstacle.setCollider("rectangle",0,0,120,80)
